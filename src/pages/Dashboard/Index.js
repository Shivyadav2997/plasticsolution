                    ...
                    <Row>
                      <Col xs="6">
                        <Button
                          className="btn-sm btn-outline-primary mb-1 ml-0 d-flex align-items-center"
                          onClick={() =>
                            history.push("/admin/v1/sales-challan-create")
                          }
                        >
                          <FaMoneyBill /> Challan
                        </Button>
                      ...
                      <Col xs="6">
                        <Button
                          className="btn-sm btn-outline-primary mb-1 ml-0 d-flex align-items-center"
                          onClick={() =>
                            history.push("/admin/v1/quotation-create")
                          }
                        >
                          <FaWallet />
                          Quotation
                    ...
                    <Row>
                      ...
                      <Col xs="6">
                        <Button
                          className="btn-sm btn-outline-info mb-1 ml-0 d-flex align-items-center"
                          onClick={() =>
                            history.push("/admin/v1/return-purchase-invoice")
                          }
                        >
                          <FaBackward /> Return
                        </Button>
                    ...
                    <Row>
                      ...
                      <Col xs="6">
                        <Button
                          ...
                          onClick={() => {
                            sessionStorage.setItem("openAdd", true);
                            history.push("/admin/v1/product-list");
                          }}
                        >
                          <AiOutlineDropbox />
                          Product
